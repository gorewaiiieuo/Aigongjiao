package com.example.a20182.Game.FlappyBird.view;
...
import com.example.a20182.Game.FlappyBird.view.BaseView;
import com.example.a20182.Game.FlappyBird.config.Config;
import com.example.a20182.Game.FlappyBird.config.Constants;
import com.example.a20182.Game.FlappyBird.object.Bird;
import com.example.a20182.Game.FlappyBird.object.Column;
import com.example.a20182.Game.FlappyBird.object.Ground;
import com.example.a20182.Game.FlappyBird.util.FileManager;
import com.example.a20182.Game.FlappyBird.util.SoundPlayer;
...
public class MainView extends BaseView {
	...
	public MainView(Context context, SoundPlayer soundPlayer) {
		...
		if(fileManager.sdIsAvalible()) {
			...
			//Looper.prepare();
			Toast.makeText(this.mainActivity.getApplicationContext(), "SD卡不可用", Toast.LENGTH_LONG).show();
			//Looper.loop();
		}
