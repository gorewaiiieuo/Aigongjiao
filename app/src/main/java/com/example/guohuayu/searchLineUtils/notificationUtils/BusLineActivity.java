...
import com.example.guohuayu.searchLineUtils.HorizontalListView;
import com.example.guohuayu.searchLineUtils.StationState;
import com.example.guohuayu.searchLineUtils.lineAdapter;
import com.example.guohuayu.FragmentSetting;
...
public class BusLineActivity extends AppCompatActivity implements AMap.OnMapLoadedListener{
    ...
    final TimerTask task0 = new TimerTask() {
        ...
        public void run() {
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    //关闭震动提醒
                    if(ServiceSubclass.stopShark){
                        VibrateUtil.vibrateCancle(BusLineActivity.this);
                        ServiceSubclass.stopShark = false;
                    }
                    if(curpos != drawpos) {
                        curpos = drawpos;
                        //当实时站点为预设站点时开始提醒
                        if((!FragmentSetting.isEarlier && preStation==curpos)
                                ||(FragmentSetting.isEarlier && preStation-1==curpos)){
                            clockAlert();
                        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(pos!=-1) {
            ...
            if(SearchLineActivity.buslineInfo==null){
                SearchLineActivity.buslineInfo = SearchLineActivity.markedBusline;
            }
            BusLineInfo info = SearchLineActivity.buslineInfo.get(pos);
                ...
                public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
                    ...
                    confirmDialog.setClicklistener(new ConfirmDialog.ClickListenerInterface() {
                        ...
                        public void doConfirm() {
                            ...
                            if (ServiceSubclass.stopShark) VibrateUtil.vibrateCancle(BusLineActivity.this);
